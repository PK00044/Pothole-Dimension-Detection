...
- **Speed & Accuracy:** Real-time detection
- **Lightweight:** Edge device friendly
- **Instance Segmentation:** Bounding boxes
- **Export Options:** ONNX, TensorRT, CoreML

**Training:**
- Custom dataset (Indian roads, Roboflow)
- Bounding box annotation
- Transfer learning for pothole detection

**Dimension Estimation:**
- Pixel-to-meter ratio (e.g., 1 pixel ≈ 1/320 m, adjustable)

---

## 🛠️ How the System Works

1. **Input:** Upload image/video or use live camera
2. **Preprocessing:** Resize/normalize (640x640 px)
3. **Detection:** YOLOv8 finds potholes, draws boxes
4. **Dimension Calculation:** Converts box size to meters
5. **Visualization:** Shows boxes with size labels
6. **Post-processing:** Save/download results
...
- 🏙️ Automate pothole logging for municipalities
- 🚗 Real-time alerts for drivers
- 🏢 Smart city AI analysis
- 📈 Data-driven road repair decisions
